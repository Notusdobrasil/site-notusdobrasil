...
(() => {
  ...
  form.addEventListener("submit", async (e) => {
    ...
    try {
      const res = await fetch("https://www.notus.ind.br/api/subscribe", {
        method: "POST",
...
(() => {
  ...
  formCurriculo.addEventListener("submit", async (e) => {
    ...
    try {
      const response = await fetch("https://www.notus.ind.br/api/enviar-curriculo", {
        method: "POST",
        body: formData,
      });
...
(() => {
  ...
  formGarantia.addEventListener('submit', async (e) => {
    ...
    try {
      const response = await fetch('https://www.notus.ind.br/api/enviar-garantia', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(payload),
      });
...
(() => {
  ...
  formContato.addEventListener('submit', async (e) => {
    ...
    try {
      const response = await fetch('https://www.notus.ind.br/api/enviar-contato', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(payload),
      });
